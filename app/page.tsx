...
export default function Home() {
  return (
    ...
    <div className="min-h-screen font-quicksand bg-gradient-to-b from-[#001242] via-black/90 to-black md:bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] md:from-black md:via-black/90 md:to-[#001242] md:p-10 flex flex-col justify-center">
